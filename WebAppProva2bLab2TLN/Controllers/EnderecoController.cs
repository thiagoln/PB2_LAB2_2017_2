...
namespace WebAppProva2bLab2TLN.Controllers
{
    public class EnderecoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnderecoId,Logradouro,Bairro,CEP,Numero")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnderecoId,Logradouro,Bairro,CEP,Numero")] Endereco endereco)
        {
            if (ModelState.IsValid)
            {
